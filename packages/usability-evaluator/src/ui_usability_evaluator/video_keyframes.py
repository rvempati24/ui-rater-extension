...
from .evidence import atomic_write_json, canonical_sha256, sha256_file
...
def main() -> int:
    ...
    parser.add_argument(
        "--policy",
        default=str(resources.joinpath("policies/frame-policy.method3-v1.json")),
    )
    parser.add_argument(
        "--calibration",
        default=str(resources.joinpath(
